...
OCTAVE_BAND_CENTER_FREQUENCIES_HZ = np.array([125.0, 250.0, 500.0, 1000.0, 2000.0, 4000.0, 8000.0])

REFERENCE_ABSORPTION_DB_PER_M = {
    (15.0, 70.0): [0.000376, 0.001124, 0.002358, 0.004079, 0.008777, 0.026608, 0.094962],
    (20.0, 70.0): [0.000335, 0.001124, 0.002791, 0.004978, 0.009039, 0.023086, 0.077633],
    (10.0, 80.0): [0.000373, 0.001018, 0.001963, 0.003566, 0.008789, 0.028966, 0.104565],
    (25.0, 50.0): [0.000394, 0.001313, 0.003223, 0.005677, 0.010204, 0.025863, 0.086573],
}


@pytest.mark.parametrize(
    ("temperature_celsius", "relative_humidity_percent"), list(REFERENCE_ABSORPTION_DB_PER_M)
)
def test_absorption_matches_published_table(
    temperature_celsius: float, relative_humidity_percent: float
) -> None:
    expected = REFERENCE_ABSORPTION_DB_PER_M[(temperature_celsius, relative_humidity_percent)]
